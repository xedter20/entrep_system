        ...
        <div className="mx-auto max-w-2xl py-32 sm:py-48 lg:py-25">
          <div className="text-center">
            ...
            <p className="mt-6 text-lg leading-8 text-gray-600">
              Creating an application for entrepreneurs involves developing a
              user-friendly platform that caters to the specific needs and
              challenges faced by individuals starting and managing their own
              businesses. Below is a description of key features and components
              that can be included in an entrepreneur application:
            </p>
